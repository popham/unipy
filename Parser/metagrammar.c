...
static dfa dfas[6] = {
    {256, CUC("MSTART"), 6, 0, 2, states_0,
     "\070\000\000"},
    {257, CUC("RULE"), 4, 0, 5, states_1,
     "\040\000\000"},
    {258, CUC("RHS"), 3, 0, 2, states_2,
     "\040\010\003"},
    {259, CUC("ALT"), 3, 0, 2, states_3,
     "\040\010\003"},
    {260, CUC("ITEM"), 4, 0, 5, states_4,
     "\040\010\003"},
    {261, CUC("ATOM"), 4, 0, 4, states_5,
     "\040\000\003"},
};
